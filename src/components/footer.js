                    ...
                    <section class='footer-top'>
                        <div class='grid-30-70'>
                            <div class='logo-footer'>
                                <div>
                                    <a href='/'>
                                        <svg width='117' height='40' viewBox='0 0 117 40' fill='none'
                                    ...
                                    <ul class="social-links">
                                        <li>
                                            <a href="https://www.linkedin.com/company/mojoauth" target="_blank"
                                                rel="noreferrer">
                                                <svg enable-background="new 0 0 56.693 56.693" height="24" id="Layer_1"
                                                    version="1.1" viewBox="0 0 56.693 56.693" width="24"
                                                    xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <li>
                                            <a href="https://twitter.com/mojoauth" target="_blank" rel="noreferrer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" class="ionicon"
                            ...
                            <div class='grid-33'>
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li>
                                            <a href='https://mojoauthassist.freshdesk.com/support/tickets/new'>Help
                                                Center</a>
                                        </li>
                                        <li>
